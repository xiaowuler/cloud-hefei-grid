...
public class SystemSettingController {
    ...
    public PageResult<SystemSetting> findAllByPage(@RequestParam int page, @RequestParam int rows){
        return settingService.findAllByPage(page, rows);
    }

    @PostMapping("updateValueById")
    public void updateValueById(@RequestParam int id, @RequestParam int value){
